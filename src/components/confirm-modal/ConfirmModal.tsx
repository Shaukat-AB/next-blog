...
const ConfirmModal = ({
    ...
    return (
        <div
            ...
            className={`${
                !open ? "hidden" : "flex"
            } overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-black/20`}
            onClick={onClose}
        >
            <div className="relative p-4 w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="px-4 py-4 md:p-5 text-center">
                        <ConfirmAttention className="mx-auto text-4xl mb-2 text-gray-500 dark:text-gray-400" />
